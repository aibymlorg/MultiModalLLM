...
def ollama_vision(messages, model="llava:34b", temperature=0.0, max_tokens=4096):
    """
    Function to interact with local Ollama models for vision tasks
    Supports: llava:34b, llama4:scout, qwen2.5v1:72b
    """
    ...
    try:
        response = requests.post(url, json=payload, timeout=300)  # 5 minute timeout for large models
        ...
        raise Exception("Request timed out. Large models may take longer to respond.")

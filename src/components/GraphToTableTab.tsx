...
export default function GraphToTableTab() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/graph-to-table', {
        method: 'POST',
        headers: {
    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold">Graph to Table Conversion</h3>
          <ProviderStatus 
      ...
      {result && (
        <div>
          <h4 className="font-medium mb-2">Table Output:</h4>
